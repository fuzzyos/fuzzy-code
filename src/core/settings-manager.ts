import type { Transport } from "@fuzzyos/fuzzy-ai";
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.FUZZY_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.FUZZY_HARDWARE_CURSOR === "1";
	}
