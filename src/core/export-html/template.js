    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="fuzzy-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="fuzzy-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'fuzzy-share:v1:sidebar-width';
