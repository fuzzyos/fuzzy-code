 ...
 *
 * Uses file locking to prevent race conditions when multiple fuzzy instances
...
export class AuthStorage {
	 ...
	 * Multiple fuzzy instances may try to refresh simultaneously when tokens expire.
	 */
