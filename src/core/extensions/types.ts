...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@fuzzyos/fuzzy-code` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@fuzzyos/fuzzy-code";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown fuzzy and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Fuzzy loaded without re-discovering resources. */
...
/** Configuration for registering a provider via fuzzy.registerProvider(). */
...
export type ExtensionFactory = (fuzzy: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for fuzzy.* API methods.
