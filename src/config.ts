...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/fuzzyos/fuzzyos/releases/latest`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.FUZZY_PACKAGE_DIR;
	if (envDir) {
...
const piConfigName: string | undefined = pkg.fuzzyConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@fuzzyos/fuzzy-code";
export const APP_NAME: string = piConfigName || "fuzzy";
export const APP_TITLE: string = piConfigName ? APP_NAME : "fuzzy";
export const CONFIG_DIR_NAME: string = pkg.fuzzyConfig?.configDir || ".fuzzy";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., FUZZY_CODE_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODE_DIR`;
export const ENV_SESSION_DIR = `${APP_NAME.toUpperCase()}_CODE_SESSION_DIR`;
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.FUZZY_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.fuzzy/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.fuzzy/agent/) */
