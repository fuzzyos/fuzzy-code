...
import { Container, Image, Spacer, Text } from "@fuzzyos/fuzzy-tui";
import { getBundledInteractiveAssetPath } from "../../../config.ts";
import { theme } from "../theme/theme.ts";
import { DynamicBorder } from "./dynamic-border.ts";

const BLOG_URL = "https://fuzzyos.com/posts/2026-04-08-ive-sold-out/";
const IMAGE_FILENAME = "fuzzylogic.png";
...
export class EarendilAnnouncementComponent extends Container {
	constructor() {
		...
		this.addChild(new Text(theme.bold(theme.fg("accent", "fuzzy has joined Earendil")), 1, 0));
