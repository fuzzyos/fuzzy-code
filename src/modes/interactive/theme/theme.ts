...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@fuzzyos/fuzzy-tui";
...
const THEME_KEY = Symbol.for("@fuzzyos/fuzzy-code:theme");
...
export function getSettingsListTheme(): import("@fuzzyos/fuzzy-tui").SettingsListTheme {
	return {
