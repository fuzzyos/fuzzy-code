 ...
 * Delegates to fuzzy-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   fuzzy -e ./packages/fuzzy-code/examples/extensions/custom-provider-gitlab-duo
...
export default function (fuzzy: ExtensionAPI) {
	fuzzy.registerProvider("gitlab-duo", {
