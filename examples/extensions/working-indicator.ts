 ...
 * working indicator shown while fuzzy is streaming a response.
 *
 * Usage:
 *   fuzzy --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore fuzzy's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@fuzzyos/fuzzy-code";
...
export default function (fuzzy: ExtensionAPI) {
	...
	fuzzy.registerCommand("working-indicator", {
