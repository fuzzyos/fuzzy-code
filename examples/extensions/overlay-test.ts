 ...
 *
 * Usage: fuzzy --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@fuzzyos/fuzzy-tui";

export default function (fuzzy: ExtensionAPI) {
	fuzzy.registerCommand("overlay-test", {
