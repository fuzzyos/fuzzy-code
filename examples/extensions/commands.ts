 ...
 * Commands Extension
 *
 * Demonstrates the fuzzy.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@fuzzyos/fuzzy-code";

export default function commandsExtension(fuzzy: ExtensionAPI) {
	fuzzy.registerCommand("commands", {
