 ...
 *
 * Shows fuzzy.events for communication between extensions. One extension
...
export default function (fuzzy: ExtensionAPI) {
	...
	fuzzy.events.on("my:notification", (data) => {
