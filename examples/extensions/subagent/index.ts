 ...
 *
 * Spawns a separate `fuzzy` process for each subagent invocation,
...
export default function (fuzzy: ExtensionAPI) {
	fuzzy.registerTool({
		...
		description: [
			...
			'Default agent scope is "user" (from ~/.fuzzy/agent/agents).',
			'To enable project-local agents in .fuzzy/agents, set agentScope: "both" (or "project").',
		].join(" "),
