...
import type { ExtensionAPI, ExtensionCommandContext } from "@fuzzyos/fuzzy-code";
import { DynamicBorder, getMarkdownTheme } from "@fuzzyos/fuzzy-code";
import { Container, Markdown, matchesKey, Text } from "@fuzzyos/fuzzy-tui";
...
export default function (fuzzy: ExtensionAPI) {
	fuzzy.registerCommand("summarize", {
