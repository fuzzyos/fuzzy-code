...
Play DOOM as an overlay in fuzzy. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
fuzzy --extension ./examples/extensions/doom-overlay
```
...
- [fuzzy-doom](https://github.com/fuzzyos/fuzzyos-doom) for the original fuzzy integration
