 ...
 *   cd packages/fuzzy-code/examples/extensions/custom-provider && npm install
 *
 *   # With OAuth (run /login custom-anthropic first)
 *   fuzzy -e ./packages/fuzzy-code/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... fuzzy -e ./packages/fuzzy-code/examples/extensions/custom-provider
 *
...
// =============================================================================
// OAuth Implementation (copied from packages/fuzzy-ai/src/utils/oauth/anthropic.ts)
// =============================================================================
...
// =============================================================================
// Streaming Implementation (simplified from packages/fuzzy-ai/src/providers/anthropic.ts)
// =============================================================================
...
export default function (fuzzy: ExtensionAPI) {
	fuzzy.registerProvider("custom-anthropic", {
