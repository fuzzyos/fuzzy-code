 ...
 *
 * Usage:
 *   fuzzy -e ./built-in-tool-renderer.ts
 */

import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@fuzzyos/fuzzy-code";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@fuzzyos/fuzzy-code";
