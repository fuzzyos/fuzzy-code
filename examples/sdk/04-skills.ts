...
import { createAgentSession, DefaultResourceLoader, SessionManager, type Skill } from "@fuzzyos/fuzzy-code";
...
// Discover all skills from cwd/.fuzzy/skills, ~/.fuzzy/agent/skills, etc.
