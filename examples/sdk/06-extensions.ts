...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@fuzzyos/fuzzy-code";
...
export default function (fuzzy: ExtensionAPI) {
	...
	fuzzy.on("agent_end", async (event) => {
	...
	// Register a command
	fuzzy.registerCommand("mycommand", {
