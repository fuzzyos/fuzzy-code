> fuzzy can create prompt templates. Ask it to build one for your workflow.
...
Fuzzy loads prompt templates from:

- Global: `~/.fuzzy/agent/prompts/*.md`
- Project: `.fuzzy/prompts/*.md`
- Packages: `prompts/` directories or `fuzzy.prompts` entries in `package.json`
