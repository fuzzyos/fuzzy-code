...
import type { AssistantMessage, Model } from "@fuzzyos/fuzzy-ai";
...
vi.mock("@fuzzyos/fuzzy-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@fuzzyos/fuzzy-ai")>();
	return {
		...actual,
