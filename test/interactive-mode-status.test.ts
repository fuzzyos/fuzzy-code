...
"[Extensions]
  @scope/fuzzy-scoped, answer.ts, cli-extension.ts, HazAT/fuzzy-interactive-subagents, HazAT/fuzzy-interactive-subagents:subagents, local-index, fuzzy-markdown-preview, user-index"`);
	});
