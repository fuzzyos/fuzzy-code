...
import { Text, type TUI } from "@fuzzyos/fuzzy-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".fuzzy", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .fuzzy/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "Fuzzy documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
